          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.executors = new ArrayList<ExecutorSummary>(_list155.size);
              for (int _i156 = 0; _i156 < _list155.size; ++_i156)
              {
                ExecutorSummary _elem157; // required
                _elem157 = new ExecutorSummary();
                _elem157.read(iprot);
                this.executors.add(_elem157);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.errors = new HashMap<String,List<ErrorInfo>>(2*_map158.size);
              for (int _i159 = 0; _i159 < _map158.size; ++_i159)
              {
                String _key160; // required
                List<ErrorInfo> _val161; // required
                _key160 = iprot.readString();
                {
                  org.apache.thrift.protocol.TList _list162 = iprot.readListBegin();
                  _val161 = new ArrayList<ErrorInfo>(_list162.size);
                  for (int _i163 = 0; _i163 < _list162.size; ++_i163)
                  {
                    ErrorInfo _elem164; // required
                    _elem164 = new ErrorInfo();
                    _elem164.read(iprot);
                    _val161.add(_elem164);
                  }
                  iprot.readListEnd();
                }
                this.errors.put(_key160, _val161);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.executors != null) {
      oprot.writeFieldBegin(EXECUTORS_FIELD_DESC);
      {
        ...
        for (ExecutorSummary _iter165 : this.executors)
        {
    ...
    if (this.errors != null) {
      oprot.writeFieldBegin(ERRORS_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, List<ErrorInfo>> _iter166 : this.errors.entrySet())
        {
          oprot.writeString(_iter166.getKey());
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter166.getValue().size()));
            for (ErrorInfo _iter167 : _iter166.getValue())
            {
