...
public class SupervisorSummary implements org.apache.thrift.TBase<SupervisorSummary, SupervisorSummary._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField USED_RESOURCES_FIELD_DESC = new org.apache.thrift.protocol.TField("used_resources", org.apache.thrift.protocol.TType.MAP, (short)7);
  ...
  private Map<String,Double> total_resources; // required
  private Map<String,Double> used_resources; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    USED_RESOURCES((short)7, "used_resources");
  ...
  static {
    ...
    tmpMap.put(_Fields.USED_RESOURCES, new org.apache.thrift.meta_data.FieldMetaData("used_resources", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE))));
  ...
  public SupervisorSummary(SupervisorSummary other) {
    ...
    if (other.is_set_used_resources()) {
      Map<String,Double> __this__used_resources = new HashMap<String,Double>();
      for (Map.Entry<String, Double> other_element : other.used_resources.entrySet()) {

        String other_element_key = other_element.getKey();
        Double other_element_value = other_element.getValue();

        String __this__used_resources_copy_key = other_element_key;

        Double __this__used_resources_copy_value = other_element_value;

        __this__used_resources.put(__this__used_resources_copy_key, __this__used_resources_copy_value);
      }
      this.used_resources = __this__used_resources;
    }
  }
  ...
  public int get_used_resources_size() {
    return (this.used_resources == null) ? 0 : this.used_resources.size();
  }

  public void put_to_used_resources(String key, double val) {
    if (this.used_resources == null) {
      this.used_resources = new HashMap<String,Double>();
    }
    this.used_resources.put(key, val);
  }

  public Map<String,Double> get_used_resources() {
    return this.used_resources;
  }

  public void set_used_resources(Map<String,Double> used_resources) {
    this.used_resources = used_resources;
  }

  public void unset_used_resources() {
    this.used_resources = null;
  }

  /** Returns true if field used_resources is set (has been assigned a value) and false otherwise */
  public boolean is_set_used_resources() {
    return this.used_resources != null;
  }

  public void set_used_resources_isSet(boolean value) {
    if (!value) {
      this.used_resources = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case USED_RESOURCES:
      if (value == null) {
        unset_used_resources();
      } else {
        set_used_resources((Map<String,Double>)value);
      }
      break;
  ...
  public boolean equals(SupervisorSummary that) {
    ...
    boolean this_present_used_resources = true && this.is_set_used_resources();
    boolean that_present_used_resources = true && that.is_set_used_resources();
    if (this_present_used_resources || that_present_used_resources) {
      if (!(this_present_used_resources && that_present_used_resources))
        return false;
      if (!this.used_resources.equals(that.used_resources))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_used_resources = true && (is_set_used_resources());
    builder.append(present_used_resources);
    if (present_used_resources)
      builder.append(used_resources);
  ...
  public int compareTo(SupervisorSummary other) {
    ...
    lastComparison = Boolean.valueOf(is_set_used_resources()).compareTo(typedOther.is_set_used_resources());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_used_resources()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.used_resources, typedOther.used_resources);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.total_resources = new HashMap<String,Double>(2*_map37.size);
              for (int _i38 = 0; _i38 < _map37.size; ++_i38)
              {
                ...
                this.total_resources.put(_key39, _val40);
              }
              iprot.readMapEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.used_resources = new HashMap<String,Double>(2*_map41.size);
              for (int _i42 = 0; _i42 < _map41.size; ++_i42)
              {
                String _key43; // required
                double _val44; // required
                _key43 = iprot.readString();
                _val44 = iprot.readDouble();
                this.used_resources.put(_key43, _val44);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.total_resources != null) {
      if (is_set_total_resources()) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, this.total_resources.size()));
          for (Map.Entry<String, Double> _iter45 : this.total_resources.entrySet())
          {
    ...
    if (this.used_resources != null) {
      if (is_set_used_resources()) {
        oprot.writeFieldBegin(USED_RESOURCES_FIELD_DESC);
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, this.used_resources.size()));
          for (Map.Entry<String, Double> _iter46 : this.used_resources.entrySet())
          {
  ...
  public String toString() {
    ...
    if (is_set_used_resources()) {
      if (!first) sb.append(", ");
      sb.append("used_resources:");
      if (this.used_resources == null) {
        sb.append("null");
      } else {
        sb.append(this.used_resources);
      }
      first = false;
    }
    sb.append(")");
