  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.acked != null) {
      oprot.writeFieldBegin(ACKED_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter129 : this.acked.entrySet())
        {
          oprot.writeString(_iter129.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, _iter129.getValue().size()));
            for (Map.Entry<String, Long> _iter130 : _iter129.getValue().entrySet())
            {
    ...
    if (this.failed != null) {
      oprot.writeFieldBegin(FAILED_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter131 : this.failed.entrySet())
        {
          oprot.writeString(_iter131.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, _iter131.getValue().size()));
            for (Map.Entry<String, Long> _iter132 : _iter131.getValue().entrySet())
            {
    ...
    if (this.complete_ms_avg != null) {
      oprot.writeFieldBegin(COMPLETE_MS_AVG_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Map<String,Double>> _iter133 : this.complete_ms_avg.entrySet())
        {
          oprot.writeString(_iter133.getKey());
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, _iter133.getValue().size()));
            for (Map.Entry<String, Double> _iter134 : _iter133.getValue().entrySet())
            {
