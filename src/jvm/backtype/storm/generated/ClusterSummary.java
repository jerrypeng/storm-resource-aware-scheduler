          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.supervisors = new ArrayList<SupervisorSummary>(_list47.size);
              for (int _i48 = 0; _i48 < _list47.size; ++_i48)
              {
                SupervisorSummary _elem49; // required
                _elem49 = new SupervisorSummary();
                _elem49.read(iprot);
                this.supervisors.add(_elem49);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.topologies = new ArrayList<TopologySummary>(_list50.size);
              for (int _i51 = 0; _i51 < _list50.size; ++_i51)
              {
                TopologySummary _elem52; // required
                _elem52 = new TopologySummary();
                _elem52.read(iprot);
                this.topologies.add(_elem52);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.supervisors != null) {
      oprot.writeFieldBegin(SUPERVISORS_FIELD_DESC);
      {
        ...
        for (SupervisorSummary _iter53 : this.supervisors)
        {
          _iter53.write(oprot);
        }
        oprot.writeListEnd();
    ...
    if (this.topologies != null) {
      oprot.writeFieldBegin(TOPOLOGIES_FIELD_DESC);
      {
        ...
        for (TopologySummary _iter54 : this.topologies)
        {
          _iter54.write(oprot);
        }
        oprot.writeListEnd();
