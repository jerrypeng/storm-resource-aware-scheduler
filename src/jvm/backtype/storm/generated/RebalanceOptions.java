          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.num_executors = new HashMap<String,Integer>(2*_map168.size);
              for (int _i169 = 0; _i169 < _map168.size; ++_i169)
              {
                String _key170; // required
                int _val171; // required
                _key170 = iprot.readString();
                _val171 = iprot.readI32();
                this.num_executors.put(_key170, _val171);
              }
              iprot.readMapEnd();
            }
          } else { 
    ...
    if (this.num_executors != null) {
      if (is_set_num_executors()) {
        oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter172 : this.num_executors.entrySet())
          {
